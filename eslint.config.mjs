...
export default [
  ...
  },
  {
    ...
    // 4,891 (unit 2, the test-support verbs) → 4,731 (unit 3, admin verbs + status + backup) → 4,432 (unit 4, the document wiring) → 4,102 (unit 5, per-agent signaling) → 3,704 (unit 6, attendance and the away reply).
    //  EXACT, never with slack: a ratchet with give is a
    // line that can come back.
    files: ["core/daemon/src/daemon.ts"],
    rules: { "max-lines": ["error", { max: 3706, skipBlankLines: false, skipComments: false }] },
  },
  {
