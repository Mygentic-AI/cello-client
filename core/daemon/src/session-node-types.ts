...
export function clientSideAskFault(err: unknown): string | undefined {
 ...
 */
export function holdsCircuit(node: CelloNode): boolean {
 ...
 */
export function stopWhenSettled(node: CelloNode, work: Array<Promise<unknown> | undefined>, graceMs: number): void {
