...
function refusalsField(
  ...
  return refusals.length > 0 ? { refusals } : {};
}
      ...
      if (remaining <= 0) {
        ...
        return {
          ...
          guidance: quietRefusals.refusals
            ? "No content arrived within timeout_ms — but message(s) from this counterparty WERE received and REFUSED. See `refusals` for the reason and what to do; waiting longer will not help until it is resolved."
